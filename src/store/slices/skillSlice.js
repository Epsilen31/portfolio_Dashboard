...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://portfolio-backend-sjmc.onrender.com/api/v1/skills/getAllSkills",
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://portfolio-backend-sjmc.onrender.com/api/v1/skills/addSkill",
      data,
      {
        withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://portfolio-backend-sjmc.onrender.com/api/v1/skills/delete/${id}`,
      {
        withCredentials: true,
      }
    );
  ...
  async (dispatch) => {
    ...
    try {
      const response = await axios.put(
        `https://portfolio-backend-sjmc.onrender.com/api/v1/skills/update/${id}`,
        { proficiency },
        {
          withCredentials: true,

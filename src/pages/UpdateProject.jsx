    ...
    const getProject = async () => {
      await axios
        ...
        .then((res) => {
          ...
          // Set technologies directly as an array
          setTechnologies(
            Array.isArray(data.technologyStack) ? data.technologyStack : []
          );
          setGitRepoLink(data.githublink);
          setProjectLink(data.deployementlink);
          setProjectBanner(data.projectBanner?.url || "");
          setProjectBannerPreview(
            data.projectBanner && data.projectBanner?.url
          );
        })
        .catch((error) => {
